...
# original network
from pformer.network_architecture.synapse.pformer_synapse import MyNet

# no_gsm
# from pformer.network_architecture.synapse.pformer_synapse_lsm import MyNet

# lsm+ca
# from pformer.network_architecture.synapse.pformer_synapse_lsm_ca import MyNet

# lsm+sa
# from pformer.network_architecture.synapse.pformer_synapse_lsm_sa import MyNet

# gsm
# from pformer.network_architecture.synapse.pformer_synapse_gsm import MyNet
...
from pformer.training.network_training.Trainer_synapse import Trainer_synapse
...
class pformer_trainer_synapse(Trainer_synapse):
    """
    ...
    def initialize_network(self):
        ...
        self.network = MyNet(ch=[128, 128, 256, 512, 1024], k=[256, 128, 32, 8], num_head=[4, 8, 16, 32],
    ...
    #
    #     MRI_path = '/media/abc/disk11/unetr_plus_plus-main/DATASET_Synapse/unetr_pp_raw/unetr_pp_raw_data/Task02_Synapse/imagesTr/img0001.nii.gz'
    #
    #     model_weight_path = '/media/abc/disk11/unetr_plus_plus-main/unetr_pp/evaluation/unetr_pp_synapse_checkpoint/unetr_pp/3d_fullres/Task002_Synapse/unetr_pp_trainer_synapse__unetr_pp_Plansv2.1/fold_0/4 8 16 32/model_best.model'
    #
    ...
    #
    #     MRI_array = crop_center(MRI_array, 128, 128, 64)
    ...
    #     grayscale_cam = cam(input_tensor=MRI_tensor, targets=target_category)
    #     gradscale_cam = grayscale_cam[0, :]
    #     # 将 grad-cam 的输出叠加到原始图像上
    #     visualization = show_cam_on_image(MRI_array, grayscale_cam)
    #
    #     # 保存可视化结果
    #     cv2.imwrite('./cam.jpg', visualization[64, 64, 32])
