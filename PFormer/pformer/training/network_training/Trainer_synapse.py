...
from pformer.inference.segmentation_export import save_segmentation_nifti_from_softmax
...
from pformer.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from pformer.training.loss_functions.dice_loss import DC_and_CE_loss
from pformer.training.network_training.network_trainer_synapse import NetworkTrainer_synapse
...
class Trainer_synapse(NetworkTrainer_synapse):
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(pformer.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="pformer.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in pformer.preprocessing" % \
                                               preprocessor_name
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        if run_postprocessing_on_folds:
            # in the old pformer we would stop here. Now we add a postprocessing. This postprocessing can remove everything
