...
from pformer.configuration import default_num_threads
from pformer.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from pformer.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from pformer.experiment_planning.utils import create_lists_from_splitted_dataset
from pformer.network_architecture.generic_UNet import Generic_UNet
from pformer.paths import *
from pformer.preprocessing.cropping import get_case_identifier_from_npz
...
class ExperimentPlanner(object):
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([join(pformer.__path__[0], "preprocessing")],
                                                         self.preprocessor_name, current_module="pformer.preprocessing")
